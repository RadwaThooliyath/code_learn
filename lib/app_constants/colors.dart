...
class AppColors {
  static const Color card2 = Color(0xff423d3d);
  static const Color card1 = Color(0xffacbf3a);
  static const Color background = Color(0xff262322);
  
  // New color palette
  static const Color robinEggBlue = Color(0xff25ced1);
